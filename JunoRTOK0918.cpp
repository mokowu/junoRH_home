...
void Juno::send_A()
{
  if(flagNoSleep&&m_stuck_A.data>num_s&&m_stuck_B.data<=num_s&&
     m_stuck_B.data<m_stuck_A.data&&stopflag_A){
    //dummy
  }
  else if(!flagNoSleep&&m_stuck_B.data+2<m_stuck_A.data&&stopflag_A){
    //dummy
  }
  else{
...
void Juno::send_B()
{
  if(flagNoSleep&&m_stuck_B.data>num_s&&m_stuck_A.data<=num_s&&
     m_stuck_A.data<m_stuck_B.data&&stopflag_B){
    //dummy
  }
  else if(!flagNoSleep&&m_stuck_A.data+2<m_stuck_B.data&&stopflag_B){
    //dummy
  }
  else{
